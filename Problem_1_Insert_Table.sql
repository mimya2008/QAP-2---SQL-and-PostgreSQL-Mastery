INSERT INTO students (student_first_name, student_last_name, email, enrollment_date) VALUES
...
((SELECT student_id FROM students WHERE student_first_name = 'John' AND student_last_name = 'Doe'), (SELECT course_id FROM courses WHERE course_name = 'English 101'), '2025-01-07'),
((SELECT student_id FROM students WHERE student_first_name = 'Mike' AND student_last_name = 'Borders'), (SELECT course_id FROM courses WHERE course_name = 'Physics 101'), '2025-01-07'),
...
((SELECT student_id FROM students WHERE student_first_name = 'Lisa' AND student_last_name = 'Audrey'), (SELECT course_id FROM courses WHERE course_name = 'Math 112'), '2025-01-08'),
